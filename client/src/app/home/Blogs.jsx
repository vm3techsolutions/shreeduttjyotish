...
export default function RecentBlogs() {
    ...
    <section className="flex flex-col items-center text-center px-6 py-12 bg-[#D9D9D9]/12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-6 sm:px-4">
        {blogs.map((blog, index) => (
          <div
            key={index}
            className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col border border-[#fff] hover:border-[#B71C1C]/30"
          >
  ...
  />
            ...
            <div className="p-6 flex flex-col flex-1">
              <h3 className="text-2xl font-semibold mb-2 text-left text-[#B71C1C]">{blog.title}</h3>
